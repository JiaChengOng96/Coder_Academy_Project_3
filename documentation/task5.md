...
## 9	Explain the purpose and process of a risk assessment plan for a network. You may use examples from your network security plan from Task 1 to illustrate your answer.
	The purpose of a risk assessment plan is to able to identify the risk as well as understand the risk so that it could help to assist in identifying the risk management decision making. Risk assessment plan provide the overview of what an risk is and how it would affect the organisation in term of profit, assest and others component.


## 10	Explain the role of the following concepts in terms of the processes and techniques of object-oriented programming:
- Inheritance
...
- Encapsulation
Means that the content or internal state of an object is hidden away from the others. In programming term, a variable that exist only within a function or class can only be access within the class and not external. For example, we drive using a car however we do not need to know how to engine move the car or how the piston is moving but all we need to know is that it will drive us to the destination.
...
## 11	Describe the process for developing:
...
## 12	Identify and outline the key features of a graphical user interface (GUI), for interaction with an operator.
...
## 13	Describe the architecture of a framework for web-enabled application development.	150 - 200 words
...
## 14	Outline the techniques for implementing inter-process communication	150 - 250 words


## 15	Identify and outline testing techniques as applied to distributed application development.	
...
## 16	Identify and outline techniques for implementing third-party supplied code.	200 - 250 words


## 17	Describe the basic principles of database management systems.	150 - 250 words
...
## 18	Outline the software development life cycle (SDLC)	100 - 150 words
...
## 19	Explain the coding used to create deployment applications.	150 - 250 words


## 20	Describe the design pattern used to implement remote procedure calls in the application you created in Task 3.	150 - 250 words


## 21	Explain the information and communications technology (ICT) hardware, software, security protocols and standards and organisational policies relevant to deployment of applications.	150 - 250 words