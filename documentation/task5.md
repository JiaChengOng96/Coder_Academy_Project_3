...
- Pipes means that when an information is send from one process to another, it can only be sent in one direction. It will also be buffered at the memory until everything is received.
